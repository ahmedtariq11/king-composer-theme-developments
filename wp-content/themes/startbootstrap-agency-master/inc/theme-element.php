...
function consult_section_1($attr){
	...
	?>
	      ...
	      <header class="masthead">
            <div class="container">
                       <div class="masthead-subheading"><?php echo esc_html($title_sec_1);?></h3>
                       <div class="masthead-heading text-uppercase"> style="color:<?php echo esc_html($title_sec_desc_1_color);?>"><?php echo esc_html($title_sec_desc_1);?> </div>
